                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text("Sub Total", style: TextStyles.size20BlackW600),
                        SizedBox(width: 20.w),
                        Text("\$ ${getTotalPrice()}",
                  ...
                  Container(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text("Fees", style: TextStyles.size20BlackW600),
                        SizedBox(width: 20.w),
                        Text('20%', style: TextStyles.size14BlackW400),
                      ],
                    ),
                  ),
                  verticalSpace(20.h),
                  Container(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text("Total", style: TextStyles.size20BlackW600),
                        SizedBox(width: 20.w),
                        Text("\$ " + (getTotalPrice() / 20 * 100).toString(),
                            style: TextStyles.size14BlackW400),
                      ],
                    ),
                  ),
